...
class VolunteerDetailsScreen extends StatefulWidget{
  ...
  static String routeFromId (int id) => "${ApplyScreen.route}/$id";
...
class _VolunteerDetailsScreenState extends State<VolunteerDetailsScreen>{
  ...
  Widget build(BuildContext context) {
    VolunteerDetails volunteerDetails = _service.getVolunteerById(widget.id);
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(volunteerDetails.imagePath),
            const SizedBox(height: 24,),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Text(volunteerDetails.type.toUpperCase(), style: ProjectFonts.overline.copyWith(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: Text(volunteerDetails.mission, style:ProjectFonts.body1.copyWith(
            ...
            Padding(
              ...
              child: InkWell(
                onTap: () =>{
                  openMap(volunteerDetails.latitude, volunteerDetails.longitude)
                },
            ...
            Padding(
              ...
              child: CtaButton(
                enabled: true, 
                onPressed: () => {
                  showDialog(context: context, builder: (context) => ApplyConfirmationModal(title: volunteerDetails.title))
